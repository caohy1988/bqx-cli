...
description: Use dcx to evaluate agent sessions against latency or error-rate thresholds. Use this when the user wants to check session quality, gate CI on agent performance, or find failing sessions.
---
...
Do not use when the user wants to inspect a single session — use dcx-analytics-trace instead.
