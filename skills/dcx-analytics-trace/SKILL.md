---
name: dcx-analytics-trace
description: Use dcx to retrieve and inspect the event trace for a specific agent session. Use this when the user wants to debug a failed session, inspect event ordering, or understand what happened during a session.
---
...
Do not use when the user wants to evaluate many sessions at once — use dcx-analytics-evaluate instead.
