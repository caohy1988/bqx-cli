...
connection metadata through dcx, use `dcx jobs query` with `INFORMATION_SCHEMA` views.
...
- Connection management (create/delete/update) is not available through dcx — it requires the BigQuery Connection API
