---
name: dcx-query
description: Use the dcx CLI to run raw BigQuery SQL queries, including dry-run checks and json/table/text output. Use this when the user wants direct SQL execution through dcx rather than analytics workflows.
---
...
- Use `--dry-run` to verify what dcx will send before executing
